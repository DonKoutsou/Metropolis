...
public class Vehicle : RigidBody
{
	...
	{
		loctomove = NewLoc;
		//LocDist = loctomove.DistanceTo(GlobalTranslation);
	}
   ...
   // VehicleDamageManager DamageMan;
	 ...
	 public bool UnBoardVehicle(Character cha)
	{
		...
		{
			DialogueManager.GetInstance().ForceDialogue(cha, "FarFromLandBoatDiag");
	...
	public void DoAction(Player pl)
	{
		if (!IsPlayerOwned())
		{
			DialogueManager.GetInstance().ForceDialogue(pl, "NotMyBoatDiag");
